          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-medical-light rounded-2xl p-8"
              >
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-foreground">HMO Accepted</p>
                      <p className="text-sm text-muted-foreground">13+ HMO partners including NHIS</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Walk-in or call to book</p>
                    </div>
                  </div>
                </div>
                <div className="mt-8 space-y-3">
                  <a
                    ...
                    className="flex items-center justify-center gap-2 bg-primary text-primary-foreground rounded-xl px-6 py-3 font-semibold hover:bg-primary-dark transition-colors w-full"
                  >
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-left">
                {service.whyUs.map((reason, i) => (
                  <div key={i} className="flex items-center gap-3 bg-medical-light rounded-xl p-4">
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="tel:09155171407"
                  className="inline-flex items-center justify-center gap-2 bg-primary-foreground text-primary rounded-full px-8 py-3 font-semibold hover:bg-primary-foreground/90 transition-all"
                >
                  <Phone className="w-4 h-4" />
                  Call Now
                </a>
                <Button
                  variant="ghost"
                  size="lg"
                  className="border-2 border-primary-foreground/30 text-primary-foreground rounded-full hover:bg-primary-foreground/10"
                  onClick={() => navigate("/")}
                >
                  Back to Home
                </Button>
