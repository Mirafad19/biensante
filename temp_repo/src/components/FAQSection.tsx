      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-2xl mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Get instant answers about our services, appointments, fees, and more. Can't find what you're looking for? Speak with Joshua, our AI assistant.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-x-12 gap-y-0">
          {[faqsLeft, faqsRight].map((faqColumn, columnIndex) => (
            <Accordion key={columnIndex} type="single" collapsible className="w-full">
              {faqColumn.map((faq, i) => (
                <AccordionItem key={i} value={`col-${columnIndex}-item-${i}`} className="border-b border-border">
